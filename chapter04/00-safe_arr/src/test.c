 ...
 * @brief 普通C数组的危险性
 */
void plain_c_array_example(void);

/**
 * @brief 使用我们的“安全数组”
 */
void safe_array_example(void);

int main(int argc, char *argv[])
{
    puts("C语言的封装, 不透明指针, 私有辅助函数的体验");
...
int main(void)
{
    ...
    // output
    printf("%d\b", normal_array[10]);

    normal_array[10] = 100;

    // 数组越界, 内存污染 -> "Array out of bounds, memory corruption"
    // safe array access
